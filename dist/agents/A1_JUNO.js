...
exports.JUNO = {
    ...
    async act({ caseContext, doctrine, memory }) {
        ...
        const contradictions = (0, contradictionUtils_1.detectContradictions)(caseContext, doctrine);
        ...
        if (agentCoordination.requiresIntervention) {
            ...
            agentCoordination.conflicts.forEach((conflict) => {
        ...
        if (councilNeeds.required) {
            ...
            councilNeeds.participants.forEach((participant) => {
...
function evaluateDoctrinalAlignment(caseContext, doctrine) {
...
function determineCouncilRequirements(caseContext, contradictions) {
    let required = false;
    let type = "standard";
...
function assessContradictionSeverity(contradictions) {
...
function identifyRelevantAgents(contradiction) {
    const agents = [];
...
//# sourceMappingURL=A1_JUNO.js.map